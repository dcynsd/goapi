...
// 日志记录介质。Gohub 中使用了两种介质，os.Stdout 和文件
...
// 调试专用，不会中断程序，会在终端打印出 warning 消息。
...
// 记录对象类型的 debug 日志，使用 json.Marshal 进行编码。调用示例：
//
